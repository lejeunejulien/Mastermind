...
:Id: $Id: introspection.py,v 1.4 2005/01/05 02:28:03 aaron_watters Exp $:
"""

# $Id: introspection.py,v 1.4 2005/01/05 02:28:03 aaron_watters Exp $
...
class RemoteView(store.View):
    ...
    def rows(self, andseqs=0, assignment=None, transform=None, subsequence=None):
...
# Revision 1.4  2005/01/05 02:28:03  aaron_watters
